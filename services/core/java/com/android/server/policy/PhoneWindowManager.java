...
public class PhoneWindowManager implements WindowManagerPolicy {
    ...
    private static final int MSG_MENU_LONG_PRESS = 23;
    ...
    private void powerLongPress() {
        ...
        case LONG_PRESS_POWER_GLOBAL_ACTIONS:
            mPowerKeyHandled = true;
            if (mKeyguardSecureIncludingHidden && mGlobalActionsOnLockDisable) {
                break;
            }
    ...
    private void readConfigurationDependentBehaviors() {
        ...
        if (mDeviceHardwareKeys == 0) {
            // we now go here to handle long press home falso for
            // navigation bar home and there default should always be assist
            // and not system default nothing
    ...
    public void updateSettings() {
        ...
        synchronized (mLock) {
            ...
            mLongPressOnAppSwitchBehavior = !ActivityManager.supportsMultiWindow() ? KEY_ACTION_LAST_APP : (mLongPressOnAppSwitchBehavior == 0 ? KEY_ACTION_SPLIT : KEY_ACTION_LAST_APP);
